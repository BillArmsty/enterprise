...
const About = () => {
  return (
    ...
    <p className="company-overview">
      ...
      With a modern fleet of refrigerated trucks, we provide reliable logistics for the food, pharmaceutical, and other temperature-sensitive industries,
      earning trust through excellence and precision.
    </p>
  </section>
  )
}
